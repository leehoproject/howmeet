					...
					<div class="col-md-12 memberframe">
						<div class="form-group">
							...
							<div class="col-md-8" style="padding:0; padding-right:10px;">
								<input type="text" size="20" id="id" name="m_id" value="${member.getM_id()}" class="form-control" readonly="readonly">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-8" style="padding: 0; padding-right: 10px;">
								<input type="password" size="20" name="m_pw" id="pw" class="form-control" value="${member.getM_pw()}">
							</div>
						</div>
						<div class="form-group">
