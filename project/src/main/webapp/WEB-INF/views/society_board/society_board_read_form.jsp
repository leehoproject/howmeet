...
<form id="insert_form" name="insert_form" class="form-horizontal" action="society_replyInsert" method="GET" enctype="multipart/form-data" role="form" data-parsley-validate="true">
