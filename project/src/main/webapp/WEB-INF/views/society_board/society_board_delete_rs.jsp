...
<body>
<form id="insert_form" name="insert_form" class="form-horizontal" action="society_board_list" method="post" enctype="multipart/form-data" role="form" data-parsley-validate="true">
