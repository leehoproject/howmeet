...
<div class="container">
	<div class="row" style="padding-left:15px; padding-right:15px;">
		<form class="form-horizontal" action="society_Board_Delete" method="GET" role="form">
			...
			<div class="col-sm-12 messageframe">
				...
				<div class="col-sm-12" style="height:150px; text-align:center; ">
					<div style="margin-top: 50px;">
						...
						<span class="message">
							${sessionid}님, 게시글을 삭제하시겠습니까?
						</span>
					</div>
				</div>
				<div class="col-sm-12 text-center" style="margin-bottom:30px;">
					<button Type="submit" class="btn btn-default">삭제</button>
					<button Type="button" class="btn btn-default" onclick="location.href='societyboardlist?s_hobby=${b_dept1}&s_dept=${b_dept2}'">취소</button>
