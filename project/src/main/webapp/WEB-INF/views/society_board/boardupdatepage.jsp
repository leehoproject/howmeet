...
$(function(){
	   $(location).attr('href',"societyboardreadform?b_seq="+$(b_seq).val()+"&s_hobby="+$(s_hobby).val()+"&s_dept="+$(s_dept).val());
});
</script>
<style>
...
<div class="container">
	<div class="row" style="padding-left:15px; padding-right:15px;">
		<form class="form-horizontal" action="society_boardreadform" method="GET" role="form">
	    ...
	    <input Type="hidden" id="s_dept" name="s_dept" value="${s_dept}"/>			
			<div class="col-sm-12 messageframe">
				...
				<div class="col-sm-12 text-center" style="margin-bottom:30px;">
					<button Type="button" id="result" name="result" class="btn btn-default">확인</button>
				</div>
			</div>
		</form>
	</div>
